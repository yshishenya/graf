...
- Подтверждённая MediaScribe ошибка входного аудио теперь завершает обработку
  ...
  остаётся текущей во всех проекциях: старые расшифровки и итоги её не
  подменяют. Общий no-archive источник защищён от преждевременного удаления
  ...
  revision и без current pointer. (#5890, #5892)
