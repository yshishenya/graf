...
### Исправлено
- Управление записью использует общее меню и видимый индикатор. Уведомления ведут к нужной записи или настройкам, а готовые серверные результаты появляются в кабинете без отдельного баннера macOS. Согласованные изменения F258 включены через F6788. ([PR #6829](https://github.com/yshishenya/graf/pull/6829), #6825.)
- Появление расшифровки и итогов сохраняет проигрывание, черновик и фокус. Если готовность итогов объявлена без сохранённого результата, показывается недоступность. Приглашения сразу показывают фактическую роль, а устаревшая ссылка на реплику объясняет причину отказа.
