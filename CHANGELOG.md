...
### Безопасность
- Email login-код теперь привязан к нормализованному адресу получателя, поэтому скрытое поле email в форме подтверждения больше нельзя подменить для входа под другим участником workspace.
