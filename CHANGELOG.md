...
- Исправлена совместимость сборки подсказок разрешений и наблюдения за сеансом с SDK macOS 14. [F247, F252].
...
- Реальные выдача/отказ/отзыв разрешений, системные перезапуски и VoiceOver правил автозаписи проверены. Реальная проверка MDM отложена по решению владельца; VoiceOver страницы разрешений F247 и подписанный переход обновления F250 с сохранением разрешений и защитой записи остаются отдельными условиями публикации.
