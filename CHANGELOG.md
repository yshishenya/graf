...
- Подтверждённая MediaScribe ошибка входного аудио теперь завершает обработку
  ...
  остаётся текущей во всех проекциях и защищает общий no-archive источник от
  преждевременного удаления старой попыткой, не продлевая исходный 24-часовой
  срок хранения. (#5890, #5892)
