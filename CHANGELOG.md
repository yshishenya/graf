...
- До публикации остаётся подтверждение реальных разрешений macOS, системного перезапуска и VoiceOver для F247, звуковой проверки VoiceOver для F246; также требуется подписанный переход обновления F250 с проверкой сохранения разрешений и защиты записи.
