...
### Изменено
- Редизайн публичного лендинга: современная типографика (bento-сетки, glassmorphism-теги, улучшенные карточки "Контроль"), обновленные акценты на приватность. Изменения полностью сохраняют существующие контракты аналитики и доступность.
