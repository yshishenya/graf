...
### Изменено
- Публичный лендинг синхронизирован с `master`: обновлены hero, bento-блок итогов,
  rail сервисов для звонков и карточки контроля записи.
