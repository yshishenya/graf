...
<!-- Release features: F239 -->

### Добавлено
- _Пока нет записей._

### Изменено
- Настройки моделей итогов принадлежат Langfuse; дополнительное ограничение ГРАФ одной моделью удалено (Фича 239, issue #6642, tasks [T053, T054, T055, T056, T057, T058]); совместимость: Нужна согласованная активация GRAF, корневого набора промптов и удаления специального ограничения в LiteLLM; release notes: Модель и параметры берутся из точной версии Langfuse без значений по умолчанию в коде. Сохранены проверки целостности запросов и результатов, доставка исторических наблюдений, обычная авторизация и бюджеты шлюза. Незавершённые новые протоколы в этот выпуск не входят.; ограничения: Технический выпуск сохраняет нынешний плоский формат итогов; полноценные протоколы выпускаются отдельно после проверки всего пригодного корпуса
