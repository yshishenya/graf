...
### Изменено
- Feature 120: диалог экспорта стал компактным и показывает состав, формат и
  основные параметры напрямую; ревизии и остальные технические сведения
  перенесены в раскрываемый блок.
