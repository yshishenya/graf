...
### Исправлено
- Системная тема страницы встречи и настроек совпадает с выбранной системой светлой или тёмной палитрой. (Фича 240, issue #6959, tasks [T044, T045]); совместимость: Нет изменений данных, сохранённых настроек и нативного моста темы.; release notes: Исправлены отличающиеся цвета в системной тёмной теме. Автоматическое переключение при смене оформления ОС работает без перезагрузки страницы, в том числе без JavaScript.; ограничения: ["Установленный GRAF Dev и выпуск проверяются отдельно; исправление пока локальное."]
