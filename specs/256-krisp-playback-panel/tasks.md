...
- [ ] T013 Исправить возвращение ручки resize при изменении размера свёрнутой панели и сохранить компактную цветную разметку спикеров по повторно проверенному Krisp в rendering.py и static/cabinet/cabinet.js, cabinet.css; дополнить specs/256-krisp-playback-panel/evidence/playback-panel-runtime-check.cjs проверкой цветной общей шкалы и измерением закрытого shell до/после resize и100/200%, перепроверить фактический рисунок обоих состояний в установленном GRAF Dev и обновить PR evidence согласно FR-009/FR-017, SC-002/SC-006 (partial). Все пути кода относительно apps/server/src/twobrain_rec_server/cabinet/. (Issue #6830)
