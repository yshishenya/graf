...
- [X] T017 Найти и устранить аварийное завершение теста подтверждения в Swift6.0.3; сохранить реальный JavaScript и проверки отмены, повторить macos-diagnostic без пропуска теста. (Issue #6578)

- [X] T018 Актуализировать пять упавших серверных проверок F240/F243 по действующим подписям, фокусу итогов и маскированию аналитики; сохранить runtime evidence F058 и подтвердить все затронутые контракты в изолированной PostgreSQL. (Issue #6578)
