...
Server capability и миграцию выпускать до нового клиента. После нового клиента выполнить legacy reconciliation, затем проверить installed app; факт публикации не равен установке. Production не изменялся. GRAF Dev обновлён штатным harness до `43f7074ac0a5d2ec07318a1875d141430fff4884`; smoke13/13. Новое исправление фокуса требует следующей установленной проверки; текущие результаты CI и конкретные остатки перечислены в evidence.md.
