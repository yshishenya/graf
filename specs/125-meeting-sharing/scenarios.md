...
Ни одна петля не должна зависеть от автоматического создания аккаунта,
публичного доступа, реферальных бонусов или полной выгрузки адресной книги.
...
является consent. Ссылка не меняет scope. CTA не создаёт аккаунт.
