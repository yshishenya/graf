...
- [X] T043 Complete the approved push, PR, merge, issue closeout, notarized CalVer release, production dry run/execute, and exact deployed-SHA smoke using `docs/agent-guidance/release-and-validation.md` and `docs/agent-guidance/macos-notarization.md`.
