...
| Rollback | metadata_only_not_executed | Rollback script records switches and product-impact rules in explicit metadata-only mode; no production state change performed and no live rollback claimed. |
