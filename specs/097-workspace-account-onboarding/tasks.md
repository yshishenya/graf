...
- [ ] T007 Add PostgreSQL RLS tests proving a user can see only their offers and active spaces in `apps/server/tests/integration/test_rls_application_boundaries.py`.
