...
- [X] T040 Prepare the CalVer release, run `infra/scripts/cd-remote.sh --dry-run`, deploy only under the existing approval, and collect metadata-only browser/embedded production smoke plus rollback evidence.
