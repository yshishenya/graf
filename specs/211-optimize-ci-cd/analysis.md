...
Проверка опубликованного PR дополнительно выявила два пробела T045: наследование реальной PR-базы синтетическим тестовым helper и прежнюю строку help в соседнем CI/Postgres-контракте. Оба исправлены в тестах, без изменения требований и рабочего runner; оба файла вместе проходят 86 проверок с внешней базой. Перечень файлов T045/плана и quickstart уточнён. Новая область или task не создаются; окончательное hosted-подтверждение принадлежит последнему SHA PR.
