...
T096 — механическое согласование подсказки с уже действующим FR-010.
Обе успешные ветви prepare-release.sh предлагают git tag до immutable GO,
тогда как decide требует свежий tag, а подсказка git add не включает переносы
фрагментов. Достаточно заменить обе строки вывода указанием проверить/сохранить
