...
Планировщик дополняет старые scheduled renewal operations без schedule_version только до срока платежа при полном совпадении исходных условий. Перед выпуском отдельно сверить уже наступившие периоды и несовпадающие снимки: исполнитель направляет их на разбор и не отправляет платёж автоматически. Расширение денежных колонок до bigint проверить на восстановленной базе с замером блокировок; этот локальный прогон не доказывает миграционное окно production.
