...
- [x] The entitlement-corrected `v2026.07.24.3` remains a same-identity,
...
- [x] Versioned ZIP/PKG/checksum assets are public and readable before the
  signed appcast replaces the last-good feed.
- [x] Public appcast and archive pass post-publication HTTPS and signature
  validation; previous artifacts remain available for rollback.
- [x] Release notes explain the `.1 → .2` manual bootstrap and owner-only trust
