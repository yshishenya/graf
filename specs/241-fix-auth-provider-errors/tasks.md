...
- [x] T006 Создать commit/push/русский PR с high-risk lane и Exact source SHA, синхронизировать task-backed issues и дождаться `governance-fast` на том же SHA
