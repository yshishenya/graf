...
Lane: significant-feature, high-risk governance. Первые разделы сохраняют
исторические локальные результаты до коммита. Раздел «Заключительная проверка
выпуска 2026.09.24.1» отдельно фиксирует фактические post-merge PR checks и
release-full точного кандидата; эти области доказательств не взаимозаменяемы.
