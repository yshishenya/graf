...
- [ ] T017 [US1] Raise the default ScreenCaptureKit runtime start/stop deadlines to 60 seconds in `apps/macos/RecApp/Sources/Capture/SystemAudioCaptureService.swift`, update the source contract in `apps/macos/Shared/Tests/SystemAudioCaptureServiceTests.swift`, and prove that a real start taking longer than 30 seconds and stop taking longer than 2 seconds complete before exercising the capture-deferred update smoke.
