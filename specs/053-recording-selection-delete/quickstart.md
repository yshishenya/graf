...
6. Delete one row and confirm it leaves the active list, the page stays on the list, no persistent success/cleanup banner appears, and no report link or report page appears.
