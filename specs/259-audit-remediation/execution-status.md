...
Снимок GitHub: 2026-09-09T19:30:30.265492+00:00. Прочитаны состояния, тела и все доступные комментарии 279 исходных issues; пагинация комментариев полная. Статус GitHub — инвентарь, не новая содержательная приёмка.
...
**Остаток:** 246 OPEN, 33 CLOSED. Из них 8 исходных F225 закрыты как COMPLETED после PR #6899 и live проверки; 3 инцидента B002 закрыты как NOT_PLANNED по решению владельца через PR #6910. Прежние 22 закрытых относятся к B025/B026 и требуют отдельной итоговой приёмки. Родитель #6827 и закрытый этап #6837 не входят в исходные 279.

| Направление | Всего | Открыто | Закрыто |
| --- | ---: | ---: | ---: |
| B001 — Запуск записи и календарные уведомления | 9 | 9 | 0 |
| B002 — Сохранность локальных записей и отдельные инциденты | 3 | 0 | 3 |
...
| B019 — Корректное выделение номера фичи | 8 | 0 | 8 |
...
1. B019 завершён: PR #6899 слит, #6190–#6196 и #6189 проверены и закрыты, затем закрыт #6837. Итоговый CI: 34393822475 на 6c5a294f34f3dc848094b2f397dec60732378ee3. Повторная реализация не нужна.
2. B002 завершён отменой дальнейшего поиска по решению владельца; подробности в support-triage.md. B004/B009 остаются: матрица часового macOS-прогона и подтверждения оператора по данным/оплате. Необратимые действия и реальные списания требуют отдельного конкретного разрешения.
...
В dev-identity-review.md записаны три воспроизведённых дефекта текущего resolver и риск сохранённого патча F224: новый каталог не видит активное состояние прежнего стенда. Исходные девять issues остаются открыты. Подготовить согласованный переход состояния и проверку требований инфраструктурного этапа до реализации; чужая рабочая копия F224 сохранена.
...
| B002 | [#4460](https://github.com/yshishenya/graf/issues/4460) | CLOSED / NOT_PLANNED |
| B002 | [#4535](https://github.com/yshishenya/graf/issues/4535) | CLOSED / NOT_PLANNED |
| B002 | [#5268](https://github.com/yshishenya/graf/issues/5268) | CLOSED / NOT_PLANNED |
...
| B019 | [#6189](https://github.com/yshishenya/graf/issues/6189) | CLOSED / COMPLETED |
| B019 | [#6190](https://github.com/yshishenya/graf/issues/6190) | CLOSED / COMPLETED |
| B019 | [#6191](https://github.com/yshishenya/graf/issues/6191) | CLOSED / COMPLETED |
| B019 | [#6192](https://github.com/yshishenya/graf/issues/6192) | CLOSED / COMPLETED |
| B019 | [#6193](https://github.com/yshishenya/graf/issues/6193) | CLOSED / COMPLETED |
| B019 | [#6194](https://github.com/yshishenya/graf/issues/6194) | CLOSED / COMPLETED |
| B019 | [#6195](https://github.com/yshishenya/graf/issues/6195) | CLOSED / COMPLETED |
| B019 | [#6196](https://github.com/yshishenya/graf/issues/6196) | CLOSED / COMPLETED |
