...
5. B023/B024: Windows (78) и системная админка (40) — отдельные существенные объёмы. В текущем master исходников apps/windows нет; админка существует в открытом PR #6788. Чужие изменения не перезаписываются, интеграция проводится через проверенный результат владельца.
