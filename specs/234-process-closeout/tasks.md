...
- [X] T006 [US3] Run Spec Kit/governance validation, update the F234 changelog fragment, and attach exact-SHA evidence to the PR (governance-fast run #33639245798, SHA `bf4115d54ec0a97ab7d66c0537b49a3c24bcbd35`). (Issue #6379)
