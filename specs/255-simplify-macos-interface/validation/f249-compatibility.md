...
## Интеграция релизным оператором, 2026-09-08

Источники: F255 e76f33c54f75, F249 5bb12c4b564c, F239 a540ed3a9d19.
Приоритет владельца применён: оформление/NSMenu/Mute F255, уведомления F249.
Обработчики уведомлений подключаются при запуске приложения; создание модели
меню само по себе не обращается к UNUserNotificationCenter. Регрессия проверяет
очистку проекции при смене сессии и игнорирование запоздалого ответа без остановки
записи. Старую popover-геометрию удалили только из её отменённой проверки;
DesktopPanelPlacement и проверки доставки сохранены. Две ветви миграций сведены
добавочной 0089_merge_protocol_notify. Совместные Swift-проверки: 114 PASS;
переходы схемы/Dev governance: 87 PASS. Установленная совместная приёмка и
публичные проверки выполняются оператором на финальном SHA отдельно.
