...
Статус: **не готово к выпуску**. Дата: 2026-09-06. Docs SHA `c6bbcf3765ff7a23221ced2aca64dd809dc420f8`; исходники ещё не закоммичены. Эти результаты не являются exact-SHA CI/Dev/release evidence. Точные хеши проверенных исходников записаны в `source-digests.json`.
