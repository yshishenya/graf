...
В установленном GRAF Dev подтверждены внешний отступ и скругление общего окна,
непрозрачная правая панель и отсутствие тяжёлой тени на оболочке. Свернутая и
расширенная левая панель сохраняют одну и ту же матовую поверхность; при
сворачивании правой панели основное содержимое не обрезается. Проверка выполнена
на окне 1040×680, запись не запускалась.

Кабинетный слой для проверки навигации временно отдавался локальным
