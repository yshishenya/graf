...
- [ ] T019 [US1] Вернуть исходные sidebar/profile из `c6bbcf376` в `DesktopCabinetWorkspaceView.swift`, `EmbeddedCabinetWebView.swift`, `sections.html`, `cabinet.css`, `cabinet.js`; удалить bridge и его тесты, восстановить существующие контракты; проверить совместно с F249 и установить штатный GRAF Dev. Владелец #6754. Evidence: `validation/navigation-restore.md`.
