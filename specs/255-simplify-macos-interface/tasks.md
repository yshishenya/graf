...
- [ ] T020 [US3] Провести свежий UI-аудит установленного Krisp и GRAF, изучить Apple HIG; описать детали меню, общую геометрию и варианты материалов без изменения привычных путей в `validation/krisp-review.md`. Владелец #6756. Старые T002–T009/T015 в части native sidebar/bridge отменены владельцем, а не выполнены.
