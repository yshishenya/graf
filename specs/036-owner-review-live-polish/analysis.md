...
| A4 | Tracker Sync | LOW | `issues.md`, `tasks.md` T065 | GitHub issue state is reconciled: only owner proof issues remain open after the installed-app walkthrough closeout. | Keep #1131/#1132 open until authenticated owner proof is captured in an accessible browser context. |
...
- T065: final GitHub issue closeout remains checked for the already-closed
  tracker sync, while #1131/#1132 stay open as truthful owner-proof tails.
