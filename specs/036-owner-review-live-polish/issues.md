...
Last verified: 2026-06-22 with
`gh issue list --repo yshishenya/crisp --state all --label feature:036`.

## Task Mapping

| Task | Issue | GitHub state | Notes |
|------|-------|--------------|-------|
...
| T005 | #1111 | closed | Owner-review live proof contract tests. |
| T006 | #1112 | closed | Notes/action truth schema contract tests. |
| T007 | #1113 | closed | Readiness claim regression tests. |
| T008 | #1114 | closed | Web owner session integration scaffold. |
| T009 | #1115 | closed | Notes/action view-model unit scaffold. |
| T010 | #1116 | closed | Desktop polish/accessibility scaffold. |
| T011 | #1117 | closed | Safe evidence helpers. |
| T012 | #1118 | closed | Feature 036 readiness constants. |
| T013 | #1119 | closed | Session-cookie extraction unit tests. |
| T014 | #1120 | closed | `/meetings` session-cookie integration tests. |
| T015 | #1121 | closed | Expired/invalid/denied web session tests. |
| T016 | #1122 | closed | Smoke scripts no raw token tests. |
| T017 | #1123 | closed | Sanitized live proof output tests. |
| T018 | #1124 | closed | Browser-safe session cookie extraction. |
| T019 | #1125 | closed | Web owner tenant-scope dependency. |
| T020 | #1126 | closed | Cabinet HTML web tenant-scope usage. |
| T021 | #1127 | closed | HttpOnly owner review session cookie behavior. |
...
| T030 | #1136 | closed | Web shell notes/action copy tests. |
| T031 | #1137 | closed | Notes/action no-private-content regression. |
| T032 | #1138 | closed | Notes/action response models. |
| T033 | #1139 | closed | Notes/action truth derivation. |
| T034 | #1140 | closed | Notes/action list/detail responses. |
| T035 | #1141 | closed | Structured outcome status rendering. |
| T036 | #1142 | closed | Cabinet fixtures for notes/action states. |
| T037 | #1143 | closed | Notes/action truth evidence. |
| T038 | #1144 | closed | Web list/detail IA and responsive tests. |
| T039 | #1145 | closed | Desktop workspace product-surface tests. |
| T040 | #1146 | closed | Capture control accessibility regressions. |
| T041 | #1147 | closed | Desktop embedded route policy regressions. |
| T042 | #1148 | closed | Meeting list layout and labels polish. |
| T043 | #1149 | closed | Meeting detail layout and panels polish. |
...
- Issues #1107-#1172 were created with labels `feature:036`, `priority:*`,
  `area:*`, `gate:*`, and `type:*`.
