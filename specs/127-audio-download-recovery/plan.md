...
**Structure Decision**: исправление остаётся в общем server-rendered menu handler; существующий server egress и macOS navigation policy покрываются текущими контрактами и не дублируются новым слоем.
