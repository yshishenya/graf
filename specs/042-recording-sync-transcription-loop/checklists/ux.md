...
- [x] CHK001 Are user-visible labels required for every queue/review state:
...
- [x] CHK002 Are next-action requirements defined for automatic retry, manual
  retry, stop retry, open review, wait, contact operator, auth required, and
  deletion/access blocked states? [Completeness, Spec US5]
- [x] CHK003 Are requirements defined for both web browser review and embedded
...
- [x] CHK004 Are empty, partial, processing, failed, and unavailable transcript
  states described without fake transcript/notes content? [Completeness, Spec
  US4/US6]

## Requirement Clarity

- [x] CHK005 Is the desktop/web authority boundary clear: native controls own
  capture/upload truth, server web owns transcript/review/governance truth?
  [Clarity, Plan Implementation Approach]
- [x] CHK006 Are copy requirements clear enough to avoid overpromising offline
  upload success when local package quality/privacy gates block upload?
  [Clarity, Spec US1/US5]
- [x] CHK007 Are notes/action requirements explicitly deferred or made
