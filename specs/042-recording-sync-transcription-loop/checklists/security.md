...
- [x] CHK001 Are all egress paths named, including desktop-to-server API,
  ...
  Constitution III]
- [x] CHK002 Are forbidden-content rules defined for logs, diagnostics,
...
- [x] CHK003 Are authorization requirements defined for browser review,
