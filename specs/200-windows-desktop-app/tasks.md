...
- [ ] T086 [P] Проверить живьём возврат окна из значка области уведомлений: закрытие окна теперь скрывает его, приложение остаётся в значке (проверено: процесс жив, окно в списке `hidden`), но щелчок по значку мышью в раунде 35 сделать не удалось, а искусственные сообщения значку до обработчика не доходят. Нажать значок, убедиться, что окно вернулось и кабинет на месте. Доказательства: `specs/200-windows-desktop-app/validation-2026-09-17.md`, раздел раунда 35.
