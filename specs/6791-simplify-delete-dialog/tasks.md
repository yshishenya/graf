...
- [X] T002 [US1] Сократить _render_delete_confirmation в apps/server/src/twobrain_rec_server/cabinet/review_policy_rendering.py до заданного текста и кнопок; убрать ссылку, сохранить защиту и доступность (FR-001–006). (Issue #6853)
...
Одно изменение общего renderer; использовать существующие стили/JS/серверное удаление. Не менять общий BOUNDED_DELETE_COPY. Область и новые изменения сверить через speckit-converge.
