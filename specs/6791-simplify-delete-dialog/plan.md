...
- Scope: общий renderer, параметр обработчика фокуса, разрешение существующего адреса формы в native route policy, штатное изменение размеров нового WebView после возврата, целевые контракты и проверки, changelog fragment.
