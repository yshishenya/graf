...
- [X] T115 Prove production new first-party/manual automatic conversion, transient recovery, inventory-before-mutation backfill, Chrome/embedded Range playback, transcript independence, migration/worker health and residue-zero cleanup in `specs/099-review-m4a-normalization/validation/release-closeout.md`
- [X] T116 Close task-backed GitHub issues only after evidence comments, update product status, verify branch/worktree cleanup and record feature 097/scan still deferred in `specs/099-review-m4a-normalization/validation/release-closeout.md`
