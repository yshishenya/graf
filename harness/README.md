...
`https://github.com/yshishenya/graf-development-harness/releases/tag/v0.1.6`;
`v0.1.5` remains the rollback ref. A consumer must pin the immutable release
and update its migration notes and rollback ref together.

The next planned release is `v0.1.7`. Until it is cut, keep `VERSION` and the
