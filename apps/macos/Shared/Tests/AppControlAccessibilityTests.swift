...
final class AppControlAccessibilityTests: XCTestCase {
    ...
    func testMeetingDetectionSettingsExposeDetectAndAskAndAutoRecordList() throws {
        ...
        XCTAssertTrue(source.contains("Button(\"Повторить\")"))
        XCTAssertTrue(source.contains("Не сохранено."))
        XCTAssertTrue(source.contains("ForEach(filteredTargets"))
    ...
    func testDesktopAppInstallsStandardEditMenuCommandsForEmbeddedCabinetFields() throws {
        ...
        XCTAssertTrue(source.contains("LocalSettingsFallbackView("))
        XCTAssertFalse(source.contains("NSTabViewController"))
