...
final class AppControlAccessibilityTests: XCTestCase {
    ...
    func testMeetingDetectionSettingsExposeDetectAndAskAndAutoRecordList() throws {
        ...
        XCTAssertTrue(source.contains("technicalHintIcon"))
        XCTAssertTrue(source.contains("TechnicalHintView"))
        XCTAssertTrue(source.contains("NSPopover"))
        XCTAssertTrue(source.contains("mouseEntered"))
        XCTAssertTrue(source.contains("preferredEdge: .minX"))
        XCTAssertFalse(source.contains(".help(detail)"))
        XCTAssertFalse(source.contains("toolTip = detail"))
