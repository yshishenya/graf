...
final class CaptureControlTests: XCTestCase {
    ...
    func testMeetingDetectionPrerequisiteDoesNotUseStopInProgressAsIndicatorAvailability() throws {
        ...
        XCTAssertTrue(source.contains("requiresAssistedAuthorization: true"))
        XCTAssertFalse(source.contains("requiresAssistedAuthorization: false"))
        XCTAssertTrue(source.contains("guard let policy = registry.assistedAutoStartPolicy"))
    ...
    func testMeetingDetectionReconcilesRegistryRecoveryAndPromptOutcomes() throws {
        ...
        XCTAssertTrue(source.contains("outcome: .terminal(reason: \"user_skipped\")"))
