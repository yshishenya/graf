...
def test_cabinet_js_owns_component_dom_behavior() -> None:
    ...
    for marker in [
        ...
        'document.querySelector("[data-delete-dialog][open], [data-meeting-delete-dialog][open], [data-manual-upload-dialog][open], [data-content-export-dialog][open], [data-meeting-context-panel=details][open]")',
