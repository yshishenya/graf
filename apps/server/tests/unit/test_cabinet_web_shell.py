...
def test_web_shell_uses_base_template_and_static_assets() -> None:
    ...
    assert '<body data-surface-mode="standalone_browser" data-graf-analytics-private="true"' in page
    assert 'data-ph-mask="true"' in page
    assert 'data-ym-hide-content="true"' in page
    assert 'data-icon="audio"' in page
...
def test_legacy_embedded_render_helpers_keep_webview_shell_contract() -> None:
    ...
    for page in (list_page, detail_page):
        ...
        assert '<body data-surface-mode="desktop_embedded" data-graf-analytics-private="true"' in page
        assert 'data-ph-mask="true"' in page
        assert 'data-ym-hide-content="true"' in page
