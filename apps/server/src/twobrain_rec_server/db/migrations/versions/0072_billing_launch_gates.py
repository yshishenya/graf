"""Persist versioned billing launch approvals and fail closed by default."""
...
revision: str = "0072_billing_launch_gates"
down_revision: str | None = "0071_fair_use_capability_prefix"
