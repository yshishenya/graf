"""Bound referral attribution binding to one validated token hash."""

from collections.abc import Sequence

from alembic import op

revision: str = "0050_referral_token_lookup_context"
down_revision: str | None = "0049_account_closure_requests"
