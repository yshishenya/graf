...
Revision ID: 0015_external_calendar_selection
Revises: 0014_calendar_settings_prefs
...
revision: str = "0015_external_calendar_selection"
down_revision: str | None = "0014_calendar_settings_prefs"
