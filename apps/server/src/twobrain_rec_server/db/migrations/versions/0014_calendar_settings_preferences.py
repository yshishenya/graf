...
Revision ID: 0014_calendar_settings_prefs
Revises: 0013_workspace_admin_panel
...
revision: str = "0014_calendar_settings_prefs"
down_revision: str | None = "0013_workspace_admin_panel"
