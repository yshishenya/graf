...
DEFAULT_PAGE_CLASS_POLICIES: tuple[PageClassAnalyticsPolicy, ...] = (
    ...
    _policy(
        ...
        expected_product_visible_data="none until a fair-use-safe event allowlist is approved",
        rollback_behavior="financial_analytics_disabled",
        dashboard_caveat="Review status, reason, deadline, appeal state, and references are forbidden.",
    ...
    _policy(
        ...
        expected_product_visible_data="none until a billing-safe event allowlist is approved",
        rollback_behavior="financial_analytics_disabled",
        dashboard_caveat="Plan prices, storage capacities, and trial eligibility are forbidden.",
        posthog_autocapture_state="disabled",
        page_view_allowed=False,
    ),
    _policy(
        ...
        expected_product_visible_data="none until a billing-safe event allowlist is approved",
        rollback_behavior="financial_analytics_disabled",
        dashboard_caveat="Promo codes, discount amounts, referral attribution, and expiry are forbidden.",
        posthog_autocapture_state="disabled",
        page_view_allowed=False,
    ),
    _policy(
        "billing_checkout_status",
        ("/billing/checkout/status/{safe_number}",),
        yandex_state="blocked",
        sensitivity="financial",
        dashboard_purpose="billing_safe_events_only",
        launch_state="analytics_disabled",
        ...
        expected_product_visible_data="none until a billing-safe event allowlist is approved",
        rollback_behavior="financial_analytics_disabled",
        dashboard_caveat="Invoice numbers, operation state, amounts, and provider status are forbidden.",
        posthog_autocapture_state="disabled",
        page_view_allowed=False,
    ),
    _policy(
